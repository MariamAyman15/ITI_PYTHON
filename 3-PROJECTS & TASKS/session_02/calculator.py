...
class Calc():
    ...
    def bin_to_dec(self):
        self.result = False
        decimal_value = int(self.current, 2)
        self.current = str(decimal_value)
        self.display(self.current)
 
    def hex_to_dec(self):
        self.result = False
        decimal_value = int(self.current, 16)
        self.current = str(decimal_value)
        self.display(self.current)
 
    def bin(self):
        self.result = False
        self.current = bin(int(txtDisplay.get()))
        self.display(self.current)
 
    def hex(self):
        self.result = False
        self.current = hex(int(txtDisplay.get()))
        self.display(self.current)
		
    def oct_to_dec(self):
        self.result = False
        decimal_value = int(self.current, 8)
        self.current = str(decimal_value)
        self.display(self.current)
    ...
    def oct(self):
        self.result = False
        self.current = oct(int(txtDisplay.get()))
        self.display(self.current)
...
btncos   = Button(calc, text="oct",width=6,
                  height=2,bg='black',fg='white',
                  font=('Helvetica',20,'bold'),
                  bd=4,command=added_value.oct
                 ).grid(row=4, column= 5, pady = 1)
 
btnexpm1 = Button(calc, text="bin",width=6,
                  height=2,bg='black',fg='white',
                  font=('Helvetica',20,'bold'),
                  bd = 4,command=added_value.bin
                 ).grid(row=4, column= 6, pady = 1)
 
btngamma = Button(calc, text="hex",width=6,
                  height=2,bg='black',fg='white',
                  font=('Helvetica',20,'bold'),
                  bd=4,command=added_value.hex
...
btndeg = Button(calc, text="oct>dec",width=6,
                height=2,bg='black',fg='white',
                font=('Helvetica',20,'bold'),
                bd=4,command=added_value.oct_to_dec
               ).grid(row=5, column= 5, pady = 1)
 
btnacosh = Button(calc, text="bin>dec",width=6,
                  height=2,bg='black',fg='white',
                  font=('Helvetica',20,'bold'),
                  bd=4,command=added_value.bin_to_dec
                 ).grid(row=5, column= 6, pady = 1)
 
btnasinh = Button(calc, text="hex>dec",width=6,
                  height=2,bg='black',fg='white',
                  font=('Helvetica',20,'bold'),
                  bd=4,command=added_value.hex_to_dec
